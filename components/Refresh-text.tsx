...
const RefreshText: React.FC<Props> = ({ time }) => {
  return (
    <StyledView className="justify-top text-right mb-6">
      <StyledView className="flex-row-reverse flex-shrink w-full text-right items-end justify-start">
        <StyledText className="text-right text-sm" style={{ color: "#6A6A6A" }}>
      ...
      <StyledText className="text-right text-xs" style={{ color: "#535252" }}>
